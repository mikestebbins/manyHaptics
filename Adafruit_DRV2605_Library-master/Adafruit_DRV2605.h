...
class Adafruit_DRV2605_0 {
 public:

  Adafruit_DRV2605_0(void);
  boolean begin(void);  
...
class Adafruit_DRV2605_1 {
 public:

  Adafruit_DRV2605_1(void);
  boolean begin(void);  
...
class Adafruit_DRV2605_2 {
 public:

  Adafruit_DRV2605_2(void);
  boolean begin(void);  
...
class Adafruit_DRV2605_3 {
 public:

  Adafruit_DRV2605_3(void);
  boolean begin(void);  
